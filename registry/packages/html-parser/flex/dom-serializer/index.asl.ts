 ...
 * Module dependencies
 */
import * as ElementType from "html-parser/domelementtype/index.asl";
import type {
    AnyNode,
    CDATA,
    Comment,
...
import { encodeXML, escapeAttribute, escapeText } from "html-parser/entities/index.asl";
 ...
 */
import { attributeNames, elementNames } from "./foreignNames.asl";
