import { SelectorType } from "html-parser/css-what/index.asl";
import { attributeRules } from "./attributes.asl";
import { getElementParent } from "./helpers/querying.asl";
import { compilePseudoSelector } from "./pseudo-selectors/index.asl";
import {
    type CompiledQuery,
    type CompileToken,
