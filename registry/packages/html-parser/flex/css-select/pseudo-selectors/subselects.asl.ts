...
import { type Selector } from "html-parser/css-what/index.asl";
import { cacheParentResults } from "../helpers/cache.asl";
import { findOne, getNextSiblings } from "../helpers/querying.asl";
import { includesScopePseudo, isTraversal } from "../helpers/selectors.asl";
import {
    type CompiledQuery,
    type CompileToken,
