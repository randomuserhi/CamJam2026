...
import { type Selector, SelectorType } from "html-parser/css-what/index.asl";
import { compileGeneralSelector } from "./general.asl";
import { getElementParent } from "./helpers/querying.asl";
import {
    getQuality,
    includesScopePseudo,
    isTraversal,
    sortRules,
} from "./helpers/selectors.asl";
import { PLACEHOLDER_ELEMENT } from "./pseudo-selectors/subselects.asl";
import {
    type CompiledQuery,
