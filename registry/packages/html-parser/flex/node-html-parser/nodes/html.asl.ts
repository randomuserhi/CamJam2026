import { selectAll, selectOne } from 'html-parser/css-select/index.asl';
import he from 'html-parser/he/he.asl';
import arr_back from '../back.asl';
import Matcher from '../matcher.asl';
import VoidTag from '../void-tag.asl';
import CommentNode from './comment.asl';
import Node from './node.asl';
import TextNode from './text.asl';
...
function resetParent(nodes: Node[], parent: HTMLElement | null) {
